...
class Application:
    ...
    def __init__(self):
        ...
        self.tv.column('Precio', anchor=tk.E, width=90, minwidth=90)
        self.tv.column('Cantidad', anchor=tk.E, width=88, minwidth=88)
        vsb = ttk.Scrollbar(
        ...
        self.tv.heading('Categoria', text=categoria_texto, anchor=tk.W)
        self.tv.heading('Precio', text='Precio', anchor=tk.E)
        self.tv.heading('Cantidad', text='Cantidad', anchor=tk.E)
